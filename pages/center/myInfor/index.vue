	...
	<view>
		...
		<view class="panel">
		    ...
		    <view class="line-item arrow clearfix">
		        ...
		        <view data-type="name" class="fr">
		            1992-07-28
		        </view>
		    </view>
		    <view class="line-item arrow clearfix">
		        <text class="lab">绑定手机号</text>
		        <navigator data-type="name" class="fr" hover-class="none" url="/pages/center/changePhone/change">
		            13926012343
		        </navigator>
		    </view>
		</view>
		<view class="btn save-btn">返回</view>
	</view>
</template>
<script>
	export default {
