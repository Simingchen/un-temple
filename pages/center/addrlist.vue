...
<view class="addrList-con">
    <view class="addrCon">
        ...
        <block v-if="!isEmpty">
            <view class="list-con">
                <view class="panel list-item clearfix item.Isdefault? 'default': ''" v-for="(item, index) in items" v-key="index">
                    ...
                    <view class="edit-line clearfix">
                        ...
                        <view class="fl"  data-id="{{item.ID}}" v-if="item.Isdefault == 0" @click="setDefault">
                            <text class="form-checkbox"></text>
                            <text>设为默认</text>
                        </view> 
                        <view class="fr edit-box clearfix">
                            <view class="fl edit" data-id="{{item.ID}}" @click="addNewAddr">
                                编辑
                            </view>
                            <view class="fr delete" data-id="{{item.ID}}" @click="delBtn">
                                删除
                            </view>
                        </view>
                    </view>
...
<style>
	...
	.addrList-con .form-checkbox.checked {
